    ...
    <section id="product" className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl text-gray-800 mb-4">Pure Ingredients, Gentle Care</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Every ingredient is carefully selected and sourced ethically to provide the best care for your skin.
          </p>
        </div>
